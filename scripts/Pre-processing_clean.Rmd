...
preproc_z_merged_ff <- get(output_names[7]) %>%
  full_join(get(output_names[8]), by = c("challenge", "platform_name", "time", "subject")) %>%
  full_join(get(output_names[9]), by = c("challenge", "platform_name", "time", "subject"))

preproc_z_merged_fl <- get(output_names[10]) %>%
  full_join(get(output_names[9]), by = c("challenge", "platform_name", "time", "subject")) %>%
  full_join(get(output_names[12]), by = c("challenge", "platform_name", "time", "subject"))
