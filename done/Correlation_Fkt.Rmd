...
result <- correlation_analysis(
  input_file = "/Users/laura.stotko/Downloads/postprandial_imputed.csv",
  output_file = "/Users/laura.stotko/Downloads/correlation_results.csv",
  target_variable = "insulin_biochemistry",
  exclude_columns = c("V1", "subject", "challenge_time", "challenge"),
  method = "pearson",
  p_adjust_method = "bonferroni"
)
