...
author: "Laura Stotko and Marie Hackenberg"
date: "`r Sys.Date()`"
...
run_clustering_by_challenge <- function(file_path, output_file, c_num = 8, m = 1.25, seed = 123) {
  ...
  for (current_challenge in unique(df$challenge)) {
    ...
    df_timepoints <- df_filtered[, c("metabolite", "challenge_time")]
  ...
  colnames(all_results) <- c(
    ...
    "Sub_Pathway", "Challenge", "Timepoint"
  )
...
run_clustering_by_challenge(
  ...
  output_file = "/Users/laura.stotko/Documents/Gobi-Metabolomics/Clustering/mfuzz_clusters_by_challenge_with_time.csv",
